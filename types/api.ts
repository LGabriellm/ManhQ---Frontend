...
export type UserRole = "ADMIN" | "EDITOR" | "SUBSCRIBER" | "FREE";
...
export interface EditorSubmissionsParams {
  status?: ApprovalStatus;
  page?: number;
  limit?: number;
}

export interface EditorSubmissionsResponse {
