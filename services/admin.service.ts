...
export const adminService = {
  ...
  // ===== User Management =====
  async getUsersStats(): Promise<AdminUserStatsResponse> {
    const response =
      await api.get<AdminUserStatsResponse>("/admin/users/stats");
    return response.data;
  },
  ...
  async getApprovalStats(): Promise<ApprovalStatsResponse> {
    const response = await api.get<ApprovalStatsResponse>(
      "/admin/approvals/stats",
    );
    return response.data;
  },

  async getApprovals(params?: ApprovalsParams): Promise<ApprovalsResponse> {
    const response = await api.get<ApprovalsResponse>("/admin/approvals", {
      params,
    });
    return response.data;
  },
  ...
  async bulkApprove(ids: string[]): Promise<BulkApproveResponse> {
  ...
  async bulkReject(ids: string[], reason: string): Promise<BulkRejectResponse> {
  ...
  async getMySubmissions(
    params?: EditorSubmissionsParams,
  ): Promise<EditorSubmissionsResponse> {
    const response = await api.get<EditorSubmissionsResponse>(
      "/my/submissions",
      { params },
    );
    return response.data;
